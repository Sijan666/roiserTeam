        ...
        <Container>
          <Flex className={"justify-between flex-col lg:flex-row gap-y-3"}>
            ...
            <div className="flex gap-x-3 items-center">
              ...
              <p className="text-[18px] text-[#1A1A1A] font-semibold duration-300">
                Contact
              </p>
            </div>
          </Flex>
        ...
        <Container className={"bg-[#F6F6F7] p-[60px] rounded-md"}>
          ...
          >
            ...
            <div className="right lg:w-[35%] bg-white p-8 rounded-md">
              ...
              <p className="text-[#74787C] pb-8 border-b border-[#E1E1E1]">
                Email: contact@example.com
              </p>
              <h3 className="text-[#141414] font-semibold text-[24px] pt-[25px] pb-[25px]">
                Opening Hours
              </h3>

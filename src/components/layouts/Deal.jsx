...
const Deal = () => {
  return (
    <div className="py-[100px]">
      <Container>
        <div className="bg-[url('/src/assets/dealbg.png')] bg-center bg-cover bg-no-repeat lg:py-[60px] lg:pl-[100px] p-5">
          <Flex className={"lg:items-start gap-x-[134px] flex flex-col lg:flex-row gap-y-10"}>
            <div className="pt-[45px]">
              <h2 className="font-semibold text-[25px] lg:text-[40px] text-[#1A1A1A] uppercase">
                Deal Of the days
              </h2>
              <p className="font-normal text-base text-[#74787C] lg:w-[438px] pt-2.5 pb-[30px]">
              ...
              <Flex className={"gap-x-[17px]"}>
                <div className="lg:w-[55px] h-[55px] rounded-[50%] bg-[#E53E3E] relative ">
            ...
            <div className="">
              <Flex className={"gap-x-6 flex flex-col lg:flex-row gap-y-6"}>
                <Link to={"/"}>
                  <Products
                    badgeText={"New"}

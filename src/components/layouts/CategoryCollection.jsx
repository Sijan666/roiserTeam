...
const CategoryCollection = () => {
  return (
    ...
    <Container className={'py-[100px]'}>
      <Flex className={'gap-x-4 gap-y-4 flex flex-col lg:flex-row'}>
        <div className="bg-[#E8E8E8] px-10 py-10 rounded-[10px] lg:w-1/2">
          ...
          <p className="lg:w-[390px] text-[#74787C] text-[14px] pb-10">This is genuinely the first theme i bought for which i did not had to write one line of code.</p>
          <div className="">
